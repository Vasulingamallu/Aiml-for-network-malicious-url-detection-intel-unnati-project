...
df = pd.read_csv('/content/malicious_phish.csv', nrows=20000)
...
joblib.dump(rf_classifier, 'saved_models/rf_model.pkl')

# Save XGBoost model
joblib.dump(xgb_classifier, 'saved_models/xgb_model.pkl')
